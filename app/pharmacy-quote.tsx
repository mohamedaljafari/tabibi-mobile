...
const styles = StyleSheet.create({
  ...
  formCard: { backgroundColor: "#FFFDF8", borderColor: "#E8E0D1", borderRadius: 20, borderWidth: 1, marginTop: 14, padding: 15 },
  label: { color: "#465132", fontSize: 13, fontWeight: "800", marginTop: 8, textAlign: "right" },
  multilineInput: { backgroundColor: "#FFFDF8", borderColor: "#E4DCCB", borderRadius: 13, borderWidth: 1, color: "#465132", fontSize: 13, lineHeight: 20, marginTop: 7, minHeight: 76, padding: 11, textAlignVertical: "top" },
  uploadBox: { alignItems: "center", backgroundColor: "#FCF5F5", borderColor: "#DBA5AB", borderRadius: 13, borderStyle: "dashed", borderWidth: 1, gap: 2, marginTop: 7, minHeight: 76, justifyContent: "center" },
  uploadTitle: { color: "#A65E67", fontSize: 12, fontWeight: "800" },
  uploadHint: { color: "#9A807F", fontSize: 10 },
  attachmentRow: { alignItems: "center", backgroundColor: "#FCF5F5", borderRadius: 12, flexDirection: "row-reverse", gap: 8, marginTop: 7, minHeight: 46, paddingHorizontal: 10 },
  attachmentName: { color: "#6E5558", flex: 1, fontSize: 11, textAlign: "right" },
  photoActions: { flexDirection: "row-reverse", gap: 8, marginTop: 7 },
  photoAction: { alignItems: "center", backgroundColor: "#FCF5F5", borderColor: "#ECDADD", borderRadius: 12, borderWidth: 1, flex: 1, flexDirection: "row-reverse", gap: 5, justifyContent: "center", minHeight: 46 },
  photoActionText: { color: "#A65E67", fontSize: 11, fontWeight: "800" },
  photoPreview: { alignSelf: "flex-end", marginTop: 7, position: "relative" },
  ...
  addressPicker: { alignItems: "center", backgroundColor: "#FFFDF8", borderColor: "#E8E0D1", borderRadius: 13, borderWidth: 1, flexDirection: "row-reverse", gap: 9, marginTop: 7, minHeight: 54, paddingHorizontal: 10 },
  addressCopy: { flex: 1 },
  ...
  addressMenu: { backgroundColor: "#FFFDF8", borderColor: "#E8E0D1", borderRadius: 13, borderWidth: 1, marginTop: 4, overflow: "hidden" },
  addressOption: { alignItems: "center", borderBottomColor: "#F0EBDD", borderBottomWidth: 1, flexDirection: "row-reverse", gap: 8, minHeight: 51, paddingHorizontal: 10 },
  optionPressed: { backgroundColor: "#FCF5F5" },
  noAddress: { alignItems: "center", backgroundColor: "#F8F3E8", borderRadius: 12, gap: 4, marginTop: 7, padding: 12 },
  noAddressText: { color: "#786F61", fontSize: 11, textAlign: "center" },
  profileLink: { color: "#A65E67", fontSize: 11, fontWeight: "800" },
  scopeTabs: { flexDirection: "row-reverse", gap: 6, marginTop: 7 },
  scopeTab: { backgroundColor: "#F8F3E8", borderColor: "#E4DCCB", borderRadius: 10, borderWidth: 1, flex: 1, minHeight: 39, justifyContent: "center", paddingHorizontal: 4 },
  scopeTabActive: { backgroundColor: "#F8ECEE", borderColor: "#A65E67" },
  scopeTabText: { color: "#8A8173", fontSize: 10, fontWeight: "800", textAlign: "center" },
  scopeTabTextActive: { color: "#A65E67" },
  cityRow: { alignItems: "center", backgroundColor: "#FCF5F5", borderRadius: 12, flexDirection: "row-reverse", gap: 8, marginTop: 8, padding: 10 },
  cityTitle: { color: "#6E5558", fontSize: 12, fontWeight: "800", textAlign: "right" },
  cityHint: { color: "#9A807F", fontSize: 10, marginTop: 2, textAlign: "right" },
  areaWrap: { marginTop: 8 },
  fieldHint: { color: "#8A8173", fontSize: 10, textAlign: "right" },
  areaChips: { flexDirection: "row-reverse", flexWrap: "wrap", gap: 7, justifyContent: "flex-start", marginTop: 7 },
  areaChip: { alignItems: "center", backgroundColor: "#FFFDF8", borderColor: "#DBA5AB", borderRadius: 11, borderWidth: 1, flexDirection: "row-reverse", gap: 3, paddingHorizontal: 10, paddingVertical: 8 },
  ...
  distanceRow: { alignItems: "center", backgroundColor: "#FCF5F5", borderRadius: 12, flexDirection: "row-reverse", gap: 7, marginTop: 8, minHeight: 48, paddingHorizontal: 10 },
