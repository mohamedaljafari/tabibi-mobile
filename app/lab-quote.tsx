...
export default function LabQuoteScreen() {
  ...
  const submitQuoteRequest = () => {
    ...
    const errors = validateLabQuote({ testsRequired, hasPrescription: Boolean(prescription), hasTestPhoto: Boolean(testPhotoUri), addressId: selectedAddress?.id, scope, city: cityName, selectedAreas, distanceKm });
...
const styles = StyleSheet.create({
  content: { padding: 12, paddingBottom: 20 }, header: { alignItems: "flex-start", flexDirection: "row", gap: 8 }, backButton: { alignItems: "center", backgroundColor: "#EBF1F6", borderColor: "#D8E4ED", borderRadius: 16, borderWidth: 1, height: 40, justifyContent: "center", width: 40 }, headerCopy: { flex: 1 }, title: { color: "#465132", fontSize: 21, fontWeight: "800", lineHeight: 28, textAlign: "right" }, subtitle: { color: "#8A8173", fontSize: 12, lineHeight: 17, marginTop: 2, textAlign: "right" }, notice: { alignItems: "center", backgroundColor: "#EBF1F6", borderRadius: 15, flexDirection: "row-reverse", gap: 8, marginTop: 18, padding: 11 }, noticeText: { color: "#526E89", flex: 1, fontSize: 11, lineHeight: 16, textAlign: "right" }, formCard: { backgroundColor: "#FFFDF8", borderColor: "#E8E0D1", borderRadius: 14, borderWidth: 1, marginTop: 8, padding: 10 }, label: { color: "#465132", fontSize: 12, fontWeight: "800", marginTop: 4, textAlign: "right" }, multilineInput: { backgroundColor: "#FFFDF8", borderColor: "#E4DCCB", borderRadius: 13, borderWidth: 1, color: "#465132", fontSize: 12, lineHeight: 18, marginTop: 4, minHeight: 64, padding: 8, textAlignVertical: "top" }, uploadBox: { alignItems: "center", backgroundColor: "#F4F8FB", borderColor: "#9CB5C9", borderRadius: 10, borderStyle: "dashed", borderWidth: 1, gap: 2, marginTop: 4, minHeight: 58, justifyContent: "center" }, uploadTitle: { color: "#627F9D", fontSize: 12, fontWeight: "800" }, uploadHint: { color: "#8196A7", fontSize: 10 }, attachmentRow: { alignItems: "center", backgroundColor: "#F4F8FB", borderRadius: 9, flexDirection: "row-reverse", gap: 6, marginTop: 4, minHeight: 38, paddingHorizontal: 8 }, attachmentName: { color: "#526E89", flex: 1, fontSize: 11, textAlign: "right" }, photoActions: { flexDirection: "row-reverse", gap: 6, marginTop: 4 }, photoAction: { alignItems: "center", backgroundColor: "#F4F8FB", borderColor: "#D8E4ED", borderRadius: 9, borderWidth: 1, flex: 1, flexDirection: "row-reverse", gap: 4, justifyContent: "center", minHeight: 38 }, photoActionText: { color: "#627F9D", fontSize: 11, fontWeight: "800" }, photoPreview: { alignSelf: "flex-end", marginTop: 4, position: "relative" }, photo: { borderRadius: 12, height: 92, width: 118 }, removePhoto: { alignItems: "center", backgroundColor: "#627F9D", borderRadius: 12, height: 24, justifyContent: "center", position: "absolute", right: -7, top: -7, width: 24 }, addressPicker: { alignItems: "center", backgroundColor: "#FFFDF8", borderColor: "#E8E0D1", borderRadius: 10, borderWidth: 1, flexDirection: "row-reverse", gap: 6, marginTop: 4, minHeight: 44, paddingHorizontal: 8 }, addressCopy: { flex: 1 }, addressLabel: { color: "#5A624B", fontSize: 11, fontWeight: "800", textAlign: "right" }, addressValue: { color: "#8A8173", fontSize: 9, marginVertical: 0, textAlign: "right" }, addressMenu: { backgroundColor: "#FFFDF8", borderColor: "#E8E0D1", borderRadius: 10, borderWidth: 1, marginTop: 2, overflow: "hidden" }, addressOption: { alignItems: "center", borderBottomColor: "#F0EBDD", borderBottomWidth: 1, flexDirection: "row-reverse", gap: 6, minHeight: 42, paddingHorizontal: 8 }, optionPressed: { backgroundColor: "#F4F8FB" }, noAddress: { alignItems: "center", backgroundColor: "#F8F3E8", borderRadius: 12, gap: 3, marginTop: 4, padding: 9 }, noAddressText: { color: "#786F61", fontSize: 11, textAlign: "center" }, profileLink: { color: "#627F9D", fontSize: 11, fontWeight: "800" },   cityPicker: { alignItems: "center", backgroundColor: "#FFFDF8", borderColor: "#E8E0D1", borderRadius: 10, borderWidth: 1, flexDirection: "row-reverse", gap: 6, marginTop: 4, minHeight: 42, paddingHorizontal: 8 },
