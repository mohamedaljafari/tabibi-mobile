...
const styles = StyleSheet.create({
  ...
  identityCard: { alignItems: "center", backgroundColor: "#FFFDF8", borderColor: "#E4DCCB", borderRadius: 22, borderWidth: 1, flexDirection: "row-reverse", gap: 13, marginTop: 22, padding: 18 },
  avatar: { alignItems: "center", backgroundColor: "#F0EBDD", borderRadius: 28, height: 56, justifyContent: "center", width: 56 },
  identityText: { flex: 1 },
  ...
  sectionHeader: { alignItems: "center", flexDirection: "row-reverse", justifyContent: "space-between", marginTop: 28 },
  sectionTitle: { color: "#465132", fontSize: 18, fontWeight: "800", textAlign: "right" },
  sectionHint: { color: "#8A8173", fontSize: 11, textAlign: "left" },
  addressCard: { alignItems: "center", backgroundColor: "#FFFDF8", borderColor: "#E4DCCB", borderRadius: 17, borderWidth: 1, flexDirection: "row-reverse", gap: 11, marginTop: 11, padding: 14 },
  ...
  emptyCard: { alignItems: "center", backgroundColor: "#FFFDF8", borderColor: "#E4DCCB", borderRadius: 17, borderStyle: "dashed", borderWidth: 1, flexDirection: "row-reverse", gap: 8, justifyContent: "center", marginTop: 11, padding: 16 },
  emptyText: { color: "#8A8173", fontSize: 13 },
  addAddress: { alignItems: "center", backgroundColor: "#F0EBDD", borderColor: "#D9D1C0", borderRadius: 15, borderStyle: "dashed", borderWidth: 1, flexDirection: "row-reverse", gap: 7, justifyContent: "center", marginTop: 11, minHeight: 52 },
  addAddressText: { color: "#465132", fontSize: 14, fontWeight: "800" },
  familySection: { backgroundColor: "#FFFDF8", borderColor: "#E4DCCB", borderRadius: 22, borderWidth: 1, marginTop: 28, padding: 17 },
  familyCopy: { color: "#8A8173", fontSize: 13, lineHeight: 20, marginTop: 6, textAlign: "right" },
  familyInputRow: { alignItems: "flex-end", flexDirection: "row-reverse", gap: 10, marginTop: 15 },
  familyInput: { flex: 1 },
  addFamilyButton: { alignItems: "center", backgroundColor: "#6B7B3F", borderRadius: 15, height: 56, justifyContent: "center", width: 56 },
  familyMember: { alignItems: "center", backgroundColor: "#F5F0E6", borderRadius: 14, flexDirection: "row-reverse", gap: 8, marginTop: 12, padding: 12 },
  ...
  recordsSection: { marginTop: 28 },
  recordCard: { alignItems: "center", backgroundColor: "#FFFDF8", borderColor: "#E4DCCB", borderRadius: 17, borderWidth: 1, flexDirection: "row-reverse", gap: 11, marginTop: 11, padding: 14 },
