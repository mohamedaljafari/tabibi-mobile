      ...
      <View style={styles.page}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            ...
            <View style={styles.headerCopy}><Text style={styles.title}>البحث عن طبيب</Text><Text style={styles.subtitle}>{specialty.title}</Text></View>
          </View>
...
const styles = StyleSheet.create({
  ...
  specialtyChip: { alignItems: "center", alignSelf: "flex-end", backgroundColor: "#EFF2E6", borderRadius: 12, flexDirection: "row-reverse", gap: 6, marginTop: 15, paddingHorizontal: 10, paddingVertical: 7 },
  specialtyChipText: { fontSize: 12, fontWeight: "800" },
  ...
  doctorInfo: { flex: 1 },
  doctorName: { color: "#465132", fontSize: 14, fontWeight: "800", textAlign: "right" },
  doctorSpecialty: { color: "#8A8173", fontSize: 11, marginTop: 2, textAlign: "right" },
  doctorMeta: { flexDirection: "row-reverse", gap: 9, marginTop: 6 },
