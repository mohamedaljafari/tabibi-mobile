    ...
    <ScreenContainer edges={["top", "bottom", "left", "right"]}>
      <View style={styles.page}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {providers.map((provider) => <ProviderResultCard key={provider.id} provider={buildDemoProviderAccount(provider, service.id)} serviceLabel={service.title} specialtyId={service.id} demoDoctorId={provider.id} tint={service.surface} />)}
        </ScrollView>
