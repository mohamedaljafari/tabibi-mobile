...
with Image.open(source) as source_image:
    ...
    image.crop((320, 50, 1600, 1170)).resize((768, 672), Image.Resampling.LANCZOS).save(assets / 'tabibi-mark.png', 'PNG', optimize=True, compress_level=9)
    ...
    app_icon = image.crop((320, 50, 1600, 1170)).resize((768, 672), Image.Resampling.LANCZOS)
    canvas = Image.new('RGBA', (768, 768), '#F5F0E6')
    canvas.alpha_composite(app_icon, (0, 48))
